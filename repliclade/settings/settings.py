...
class ReplicladeSettings:
    ...
    ALIGNMENTS_PATH_MAIN = os.getcwd() + os.path.sep + "filesystem" + os.path.sep + "alignment" + os.path.sep
    DNA_PATH = os.getcwd() + os.path.sep + "filesystem" + os.path.sep + "DNA" + os.path.sep
